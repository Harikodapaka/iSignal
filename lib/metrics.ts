...
export const KNOWN_METRICS: KnownMetric[] = [
    {
        key: 'sleep', displayName: 'Sleep', type: 'number', unit: 'h', color: '#007aff', emoji: '🌙', aggregation: 'last',
        aliases: [
    ...
    {
        key: 'workout', displayName: 'Workout', type: 'boolean', unit: undefined, color: '#30d158', emoji: '💪', aggregation: 'last',
        aliases: [
    ...
    {
        key: 'protein', displayName: 'Protein', type: 'number', unit: 'g', color: '#ff9f0a', emoji: '🥩', aggregation: 'sum',
        aliases: [
    ...
    {
        key: 'mood', displayName: 'Mood', type: 'number', unit: '/10', color: '#bf5af2', emoji: '😊', aggregation: 'avg',
        aliases: [
    ...
    {
        key: 'water', displayName: 'Water', type: 'number', unit: 'L', color: '#40cbe0', emoji: '💧', aggregation: 'sum',
        aliases: [
    ...
    {
        key: 'steps', displayName: 'Steps', type: 'number', unit: 'k', color: '#ff375f', emoji: '👟', aggregation: 'sum',
        aliases: [
    ...
    {
        key: 'weight', displayName: 'Weight', type: 'number', unit: 'kg', color: '#ff9f0a', emoji: '⚖️', aggregation: 'last',
        aliases: [
    ...
    {
        key: 'meditation', displayName: 'Meditation', type: 'number', unit: 'min', color: '#40cbe0', emoji: '🧘', aggregation: 'sum',
        aliases: [
    ...
    {
        key: 'reading', displayName: 'Reading', type: 'number', unit: 'min', color: '#ffd60a', emoji: '📚', aggregation: 'sum',
        aliases: [
    ...
    {
        key: 'caffeine', displayName: 'Caffeine', type: 'number', unit: 'mg', color: '#a2845e', emoji: '☕', aggregation: 'sum',
        aliases: [
    ...
    {
        key: 'calories', displayName: 'Calories', type: 'number', unit: 'kcal', color: '#ff453a', emoji: '🍽️', aggregation: 'sum',
        aliases: [
    ...
    {
        key: 'run', displayName: 'Run', type: 'number', unit: 'km', color: '#30d158', emoji: '🏃', aggregation: 'sum',
        aliases: [
    ...
    {
        key: 'energy', displayName: 'Energy', type: 'number', unit: '/10', color: '#ffd60a', emoji: '⚡', aggregation: 'avg',
        aliases: [
    ...
    {
        key: 'stress', displayName: 'Stress', type: 'number', unit: '/10', color: '#ff453a', emoji: '😰', aggregation: 'avg',
        aliases: [
    ...
    {
        key: 'screen', displayName: 'Screen Time', type: 'number', unit: 'h', color: '#636366', emoji: '📱', aggregation: 'sum',
        aliases: [
    ...
    {
        key: 'alcohol', displayName: 'Alcohol', type: 'boolean', unit: undefined, color: '#ff9f0a', emoji: '🍺', aggregation: 'last',
        aliases: [
